...
function mergePageContext(
  ...
  if (!pageContext) {
    return {
      ...
      tags: patch.tags ?? [],
      recommendedNextActions: patch.recommendedNextActions ?? [],
      ...
      dataFreshness: patch.dataFreshness ?? null,
  ...
  return {
    ...
    tags: mergedTags,
    recommendedNextActions: patch.recommendedNextActions ?? pageContext.recommendedNextActions,
    ...
    dataFreshness: patch.dataFreshness ?? pageContext.dataFreshness,
    degradedReason: patch.degradedReason ?? pageContext.degradedReason,
    raw: {
      ...(pageContext.raw ?? {}),
      ...(patch.raw ?? {}),
    },
