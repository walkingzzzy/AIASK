...
export const apiKeys = {
  ...
  execution:      (...a: unknown[]) => ['api', 'execution',       ...a] as const,
  ...
  audit:          (...a: unknown[]) => ['api', 'audit',           ...a] as const,
  ...
  notifications:  (...a: unknown[]) => ['api', 'notifications',   ...a] as const,
  admin:          (...a: unknown[]) => ['api', 'admin',           ...a] as const,
