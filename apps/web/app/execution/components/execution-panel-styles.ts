export const executionPrimaryButtonCls =
...
export const executionSecondaryButtonCls =
  'action-chip cursor-pointer text-sm text-text-primary shadow-[0_16px_32px_-24px_rgba(15,23,42,0.28)]';

export const executionChipButtonCls = 'action-chip cursor-pointer text-xs text-text-primary';

export const executionNoteCardCls = 'metric-tile rounded-[22px] p-3 text-xs text-text-secondary';

export const executionSidePanelCls = 'panel-soft rounded-[28px] p-4 sm:p-5';
