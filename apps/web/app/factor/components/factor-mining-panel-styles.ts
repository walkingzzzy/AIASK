export const factorMiningPrimaryButtonCls =
...
export const factorMiningSecondaryButtonCls = 'action-chip cursor-pointer text-xs text-text-primary';

export const factorMiningPanelCls = 'panel-soft rounded-[26px] p-4 sm:p-5';

export const factorMiningNoteCardCls = 'metric-tile rounded-[22px] p-3 text-xs text-text-secondary';
