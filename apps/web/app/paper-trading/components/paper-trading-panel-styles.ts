export const paperTradingPrimaryButtonCls =
...
export const paperTradingSecondaryButtonCls =
  'action-chip cursor-pointer text-sm text-text-primary shadow-[0_16px_32px_-24px_rgba(15,23,42,0.28)]';

export const paperTradingChipButtonCls = 'action-chip cursor-pointer text-xs text-text-primary';

export const paperTradingNoteCardCls = 'metric-tile rounded-[22px] p-3 text-xs text-text-secondary';

export const paperTradingSidePanelCls = 'panel-soft rounded-[28px] p-4 sm:p-5';
