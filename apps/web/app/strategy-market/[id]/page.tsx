    ...
    () =>
      buildLocalResultContract({
        ...
        evidence: [
          ...
          { label: '策略状态', value: String(strategy?.status ?? (emptyDetailContract ? 'empty' : detailLoading ? 'loading' : 'unknown')) },
        ...
        riskNotes: [
          ...
          ...(!promotionReady && strategy ? ['当前策略尚未达到晋级条件，进入组合前需要继续看质量门与运行风控。'] : []),
