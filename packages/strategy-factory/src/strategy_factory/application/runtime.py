...
def _build_local_runtime_view():
    StrategySpawner = _load_local_symbol("..domain.spawner", "StrategySpawner")
    ...
    FactorResearchBuilder = _load_local_symbol(".factor_research", "FactorResearchBuilder")
    StrategyFactoryScheduler = _load_local_symbol(".factory_scheduler", "StrategyFactoryScheduler")
    MarketOpportunityScanner = _load_local_symbol(".opportunity", "MarketOpportunityScanner")
