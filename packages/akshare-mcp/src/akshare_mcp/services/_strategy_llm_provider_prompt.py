        ...
        def _build_prompt(
            ...
            if compact_level >= 2:
                ...
                output_contract = {
                    ...
                    'required': ['candidates'],
                    'analysis_fields': [],
                    'candidate_fields': ['name', 'strategy_type', 'generator_mode', 'hypothesis', 'hypothesis_artifact', 'holding_horizon', 'evidence_chain', 'prediction_contract', 'confidence_contract', 'trade_plan', 'risk_rules', 'position_sizing', 'execution_notes', 'rebalance_rule', 'portfolio_spec', 'execution_assumptions', 'validation_profile', 'target_symbols', 'stock_pool', 'dsl', 'tags'],
                    'required_candidate_fields': ['name', 'strategy_type', 'hypothesis_artifact', 'evidence_chain', 'prediction_contract', 'target_symbols', 'stock_pool', 'dsl', *required_contract_fields],
            ...
            output_contract = {
                ...
                'required_candidate_fields': ['name', 'strategy_type', 'generator_mode', 'hypothesis', 'hypothesis_artifact', 'holding_horizon', 'evidence_chain', 'prediction_contract', 'trade_plan', 'risk_rules', 'position_sizing', 'execution_notes', 'rebalance_rule', 'portfolio_spec', 'execution_assumptions', 'validation_profile', 'target_symbols', 'stock_pool', 'dsl'],
                'target_symbol_rule': prompt_target_symbol_rule,
                'target_alignment_contract': {
                    'max_target_symbols': max_target_symbols,
                    'min_target_coverage_ratio': round(min_target_coverage_ratio, 4),
                ...
                'candidate_fields': ['name', 'description', 'rationale', 'strategy_type', 'generator_mode', 'hypothesis', 'hypothesis_artifact', 'holding_horizon', 'evidence_chain', 'prediction_contract', 'trade_plan', 'risk_rules', 'position_sizing', 'execution_notes', 'rebalance_rule', 'portfolio_spec', 'execution_assumptions', 'validation_profile', 'target_symbols', 'stock_pool', 'selection_logic', 'dsl', 'tags'],
                'hypothesis_required_fields': ['alpha_hypothesis', 'failure_mode', 'target_universe_hypothesis', 'family_hint', 'holding_rationale', 'alpha_half_life', 'cost_sensitivity_grid', 'position_model', 'capacity_assumption', 'market_regime_assumption', 'validation_focus'],
