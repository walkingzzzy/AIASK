...
async def search_similar_stocks(
    ...
    async with _vector_lock:
        ...
        return await _vector_search_similar_mod.search_similar_stocks(
...
async def search_by_kline(
    ...
    async with _vector_lock:
        _sync_vector_overrides()
        return await _vector_search_kline_mod.search_by_kline(
...
async def semantic_stock_search(
    ...
    async with _vector_lock:
        _sync_vector_overrides()
        return await _vector_search_semantic_mod.semantic_stock_search(
