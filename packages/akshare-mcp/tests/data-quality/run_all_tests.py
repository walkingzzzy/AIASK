...
def main():
    ...
    print("\n" + "=" * 70)
    print("当前测试集: 核心数据质量与 MCP 集成")
    print("=" * 70)
    for test_file, desc, timeout in core_tests:
    ...
    # 生成报告文件
    report_path = os.path.join(test_dir, 'DATA_QUALITY_REPORT_CORE.md')
