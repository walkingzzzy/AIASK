    ...
    def status(self) -> dict[str, Any]:
        ...
        providers = [
            ...
            },
            {
                ...
                "default": False,
                "configured": bool(str(self.env.get("HONCHO_API_KEY") or "").strip()),
                "status": "live_unverified" if str(self.env.get("HONCHO_API_KEY") or "").strip() else "skipped_missing_credentials",
