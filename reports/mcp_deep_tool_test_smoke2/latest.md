...
- Executed at: `2026-04-07T11:39:35+08:00`
- Runtime tool count: **8**
- Tools passed: **7**
- Tools failed: **1**
- Total cases: **24**
- Case pass rate: **95.83%**
- Average latency: **281.3 ms**
...
|----------|--------|---------------|
| `market_to_decision` | PASS | 2645 ms |
| `finance_to_comprehensive` | PASS | 8 ms |
| `text_to_unified_decision` | PASS | 1610 ms |
...
| `analyze_portfolio_risk` | `portfolio` | `passed` | yes | yes | 49 ms | `ok` |
| `analyze_portfolio_risk_barra` | `portfolio` | `passed` | yes | yes | 12 ms | `ok` |
| `analyze_research_report` | `general` | `failed` | no | no | 0 ms | `ok` |
| `analyze_stock_sentiment` | `sentiment` | `passed` | yes | no | 7 ms | `ok` |
| `analyze_stock_workflow` | `general` | `passed` | yes | yes | 2176 ms | `failed` |
...
- Repro payload: `{"action": "create", "code": "600519", "condition": ">", "indicator": "rsi", "user_id": "deep_user_20260407_113924", "value": 70}`
...
- Historical status: `ok`
- Implementation: `/Users/mac/Desktop/股票/packages/akshare-mcp/src/akshare_mcp/tools/managers/alerts_manager.py`
- Repro payload: `{"action": "list", "status": "active", "user_id": "deep_user_20260407_113924"}`
- Observed: `quality_meta_not_observed; source_chain_not_observed`
