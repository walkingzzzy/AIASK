...
### 
```python    def get_relation(stock_code:str = ''):
...
### 
```text[{'BlockCode': '881355.SH', 'BlockName': '软件服务', 'BlockType': '行业', 'GPNume': '234'},
...
17
 ...
 ← [
      ...
      ](https://help.tdx.com.cn/quant/docs/markdown/mindoc-1ctuhthaq5qmg/mindoc-1h10hsiat36k4.html)[
        获取新股申购信息get_ipo_info
      ](https://help.tdx.com.cn/quant/docs/markdown/mindoc-1ctuhthaq5qmg/mindoc-1h137jr3khrqo.html) →