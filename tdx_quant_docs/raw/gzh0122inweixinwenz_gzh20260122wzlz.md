...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/gzh0122inweixinwenz/gzh20260122wzlz.html
...
以下是[20250122通达信趋势财经公众号发布文章  (opens new window)](https://mp.weixin.qq.com/s/skZwgCLHzueTzxUvc4sovA)涉及的策略py文件；
 发送序列数据的TQMA510技术指标在stratexldata.py 下面的注释中。 fiststrategy.py
...
### 
```python#展示每日持仓量能看数据 验证开仓和手续费的   #用悬挂目录的时候  读不出来
from tqcenter import tq
import pandas as pd
import numpy as np
import math
...
14
 ...
 ← [
        结合VBT回测示例
      ](https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h1525ci3mnkc/mindoc-1h62qo3mceppc.html)[
        20260302公众号文章
