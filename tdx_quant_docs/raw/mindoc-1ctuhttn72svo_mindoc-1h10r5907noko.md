...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1ctuhttn72svo/mindoc-1h10r5907noko.html
...
### 
```pythondef get_sector_list(list_type: int = 0) -> List:
...
注：此接口相当于 get_stock_list('10') 数据样本

### 
```text['880081.SH', '880082.SH', '880201.SH', '880202.SH', '880203.SH', '880204.SH', '880205.SH', '880206.SH', '880207.SH', '880208.SH', ...]
