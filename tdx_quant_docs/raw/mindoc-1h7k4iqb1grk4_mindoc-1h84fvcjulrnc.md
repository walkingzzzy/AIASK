...
### 
```python    def query_stock_asset(account_id:int = -1):
...
### 
```text{'Currency': '人民币', 'Balance': '30234.070', 'Cash': '30234.070', 'Asset': '1233041.070', 'MarketValue': '1201690.000', 'ErrorId': '0'}
...
1
 ...
 ← [
      ...
      ](https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h7k4iqb1grk4/mindoc-1h7k4rp481gt4.html) →