...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h139a4ckchkk/mindoc-1h10sec960u0c.html
...
### 
```pythonsend_user_block(block_code: str = '',
                stocks: List[str] = [],
...
### 
```text{'Error': 'Add User Block Completed', 'ErrorId': '0', 'run_id': '1'}
...
1
 ...
 ← [
      ...
      ](https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h139a4ckchkk/mindoc-1h1hauh9inaac.html)[
