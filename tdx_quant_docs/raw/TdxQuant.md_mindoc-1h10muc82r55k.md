...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/TdxQuant.md/mindoc-1h10muc82r55k.html
...
### 
```pythonget_gpjy_value(stock_list: List[str] = [],
				field_list: List[str] = [],
				start_time: str = '',
				end_time: str = '') -> Dict:
...
### 
```text{'688318.SH': {'GP3': [{'Date': '20250102', 'Value': ['141405.89', '11113.00']}]}}
...
1
 ...
 ← [
      ...
      ](https://help.tdx.com.cn/quant/docs/markdown/TdxQuant.md/mindoc-1h10mdt617qss.html)[
