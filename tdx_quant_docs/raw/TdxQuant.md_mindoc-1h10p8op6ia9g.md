...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/TdxQuant.md/mindoc-1h10p8op6ia9g.html
...
### 
```pythonget_scjy_value(field_list: List[str] = [],
				start_time: str = '',
				end_time: str = '') -> Dict:
...
### 
```text{'SC1': [{'Date': '20250102', 'Value': ['184712288.00', '999820.06']}], 
