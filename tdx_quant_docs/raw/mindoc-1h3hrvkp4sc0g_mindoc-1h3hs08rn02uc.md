...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h3hrvkp4sc0g/mindoc-1h3hs08rn02uc.html
...
### 
```python    def formula_set_data_info(stock_code: str = '',
                    stock_period: str = '1d',
                    start_time: str = '',
                    end_time: str = '',
                    count: int = -1,
...
### 
```text{'ErrorId': '0', 'Msg': '向通达信公式系统设置数据信息成功！', 'run_id': '1'}
...
1
 ...
 ← [
      ...
      ](https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h3hrvkp4sc0g/mindoc-1h3hsvcct5sdc.html)[
