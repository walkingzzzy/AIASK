...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/TdxQuant.md/mindoc-1h10m001ic888.html
...
### 
```pythonget_financial_data(stock_list: List[str] = [],
					field_list: List[str] = [],
					start_time: str = '',
					end_time: str = '',
...
### 
```text{'600519.SH':     FN193  FN194  FN195 FN196  FN197 announce_time  tag_time
