...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1ctuhthaq5qmg/mindoc-1h3ru0b1tssrc.html
...
### 
```pythondef get_gb_info(stock_code:str = '',
                date_list: List[str] = [],
                count: int = 1):
...
### 
```text[{'Date': 20250101, 'Zgb': 182942480.0, 'Ltgb': 182942480.0},
