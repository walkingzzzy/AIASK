...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1ctuhttn72svo/mindoc-1h10r92mchgug.html
...
### 
```pythondef get_stock_list_in_sector(block_code: str,
                         block_type: int = 0,
...
### 
```text['159922.SZ', '510500.SH', '512500.SH']
3
