...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1ctuhthaq5qmg/mindoc-1h3rtq1hij0ac.html
...
### 
```pythondef get_more_info(stock_code:str = '',
					field_list: List = []):
