...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1ctuhthaq5qmg/mindoc-1h10g60jt68sc.html
...
### 
```pythonget_market_data(field_list: List[str] = [],
				stock_list: List[str] = [],
				period: str = '',
				start_time: str = '',
				end_time: str = '',
...
### [复权类型  (opens new window)](https://help.tdx.com.cn/quant/docs/markdown/Dict.html#%E5%A4%8D%E6%9D%83%E7%B1%BB%E5%9E%8B)
...
| dividend_type | N | str | ：none不复权、front前复权、back后复权 |
...
18
 ...
 ← [
        调用客户端功能exec_to_tdx
      ](https://help.tdx.com.cn/quant/docs/markdown/ctx.stock.md/mindoc-1h85iq443j44c.html)[
