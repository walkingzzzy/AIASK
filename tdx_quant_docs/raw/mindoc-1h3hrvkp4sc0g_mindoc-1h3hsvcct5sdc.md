...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h3hrvkp4sc0g/mindoc-1h3hsvcct5sdc.html
...
### 
```python    def formula_set_data(stock_code: str = '',
                    stock_period: str = '1d',
                    stock_data: List = [],
                    count: int = 1,
                    dividend_type: int = 0):
...
### 
```text{'ErrorId': '0', 'Msg': '向通达信公式系统设置数据成功！', 'run_id': '1'}
...
1
 ...
 ← [
      ...
      ](https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h3hrvkp4sc0g/mindoc-1h3hte6obagc0.html)[
        向通达信公式设置数据信息formula_set_data_info
      ](https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h3hrvkp4sc0g/mindoc-1h3hs08rn02uc.html) →