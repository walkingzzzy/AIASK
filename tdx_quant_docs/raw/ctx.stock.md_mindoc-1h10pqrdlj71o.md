...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/ctx.stock.md/mindoc-1h10pqrdlj71o.html
...
### 
```pythondownload_file(stock_code: str = '',
				down_time:str = '',
				down_type:int = 1):
...
11
 ...
 ← [
        缓存历史K线refresh_kline
      ](https://help.tdx.com.cn/quant/docs/markdown/ctx.stock.md/mindoc-1h10fh9m6recg.html)[
