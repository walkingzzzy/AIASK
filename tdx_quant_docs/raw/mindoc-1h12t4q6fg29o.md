...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h12t4q6fg29o.html
...
**一个简单的投资想法 => 可执行的交易策略 => 可执行的代码程序 => 检验交易策略效果 => 实盘交易验证改进** Step 1：从一个简单的投资想法开始
...
**现在，我们想知道这样操作究竟会不会赚钱？** Step 3：编写一段代码，把交易策略转成可执行的代码程序
...
这样一来，刚才细化好的策略转成了代码，计算机就能理解并执行了。 Step 4：回测或者模拟交易，检验策略效果
