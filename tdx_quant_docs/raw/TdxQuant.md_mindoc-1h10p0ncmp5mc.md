...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/TdxQuant.md/mindoc-1h10p0ncmp5mc.html
...
### 
```pythonget_bkjy_value(stock_list: List[str] = [],
				field_list: List[str] = [],
				start_time: str = '',
				end_time: str = '') -> Dict:
...
### 
```text{'880660.SH': {'BK5': [{'Date': '20250102', 'Value': ['55.28', '55.50']}],
...
5
 ...
 ← [
      ...
      ](https://help.tdx.com.cn/quant/docs/markdown/TdxQuant.md/mindoc-1h2pci5gh6h7k.html)[
        获取指定日期板块交易数据get_bkjy_value_by_date
      ](https://help.tdx.com.cn/quant/docs/markdown/TdxQuant.md/mindoc-1h10p3d31736g.html) →