...
> 来源: https://help.tdx.com.cn/quant/docs/markdown/TdxQuant.md/mindoc-1h10pk3rsg044.html
...
### 
```pythonget_gp_one_data(stock_list: List[str] = [],
...
### 
```text{'688318.SH': {'GO1': '107.41', 'GO2': '1667.00', 'GO3': '0.00', 'GO4': '2025.00', 'GO5': '1.74'}}
...
1
 ...
 ← [
      ...
      ](https://help.tdx.com.cn/quant/docs/markdown/TdxQuant.md/mindoc-1h10pe678ta04.html)[
