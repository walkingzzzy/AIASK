...
> 原始URL: https://help.tdx.com.cn/quant/docs/markdown/mindoc-1h3hrvkp4sc0g/mindoc-1h3httgemshno.html
> 抓取时间: 2026-02-03

## 函数说明

获取目前公式设置中的K线数据，使用前须先调用 `formula_set_data` 或 `formula_set_data_info` 设置公式数据。
