...
| 文档 | 说明 |
|---|---|
| [event-driven/事件驱动主题联动-结合当前代码升级方案-2026-05-24.md](event-driven/事件驱动主题联动-结合当前代码升级方案-2026-05-24.md) | **当前生效（v3）**：基于 TDX-only 数据源对齐与代码现状深度审查后的最新方案 |
| [事件驱动主题联动-策略工厂升级方案-2026-05-08.md](event-driven/事件驱动主题联动-策略工厂升级方案-2026-05-08.md) | 历史版本（v4，已被 v3 取代）。数据源章节失效，以 2026-05-24 版为准 |

> 注：原引用的 `事件驱动升级方案-数据源修订-2026-05-14.md` 在仓库中不存在，相关数据源策略已并入 2026-05-24 版 §4。
