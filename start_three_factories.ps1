...
Write-Host "  - incubation gate3 record-only audit mirror: enabled=$env:INCUBATION_FACTORY_GATE3_RECORD_ONLY_INTAKE_ENABLED, min_grade=$env:INCUBATION_FACTORY_GATE3_RECORD_ONLY_MIN_GRADE, batch_limit=$env:INCUBATION_FACTORY_GATE3_RECORD_ONLY_BATCH_LIMIT, action=record_only"
...
Write-Host "  - gate-3: record_only=$env:STRATEGY_FACTORY_GATE3_RECORD_ONLY_ENABLED, min_validation_grade=$env:STRATEGY_FACTORY_MIN_VALIDATION_GRADE"
